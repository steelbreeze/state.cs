...
namespace Steelbreeze.Behavior.StateMachines {
	...
	/// </summary>
	/// <typeparam name="TInstance">The type of the derived class.</typeparam>
	/// <remarks>
	...
	/// </remarks>
	public interface IActiveStateConfiguration<TInstance> where TInstance : class, IActiveStateConfiguration<TInstance> {
		/// <summary>
		...
		State<TInstance> this[ Region<TInstance> region ] { get; set; }
	}
}