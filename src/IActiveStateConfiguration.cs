...
namespace Steelbreeze.Behavior.StateMachines {
	...
	/// </remarks>
	public interface IActiveStateConfiguration<TInstance> where TInstance : IActiveStateConfiguration<TInstance> {
		/// <summary>
		...
		Vertex<TInstance> this[ Region<TInstance> region ] { get; set; }
	}
}